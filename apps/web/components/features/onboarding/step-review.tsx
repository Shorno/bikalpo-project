...
export interface RegistrationReviewData {
  basic: Pick<StepBasicInfoData, "phone" | "fullName" | "email">;
...
function ReviewBlock({
  ...
  return (
    <RegistrationSection title={title} className="last:border-b-0">
...
export function StepReview({
  ...
  return (
    <div className="w-full">
      <ReviewBlock title="Account information" step={1} onEdit={onEdit}>
        <RegistrationReviewRow
      ...
      <ReviewBlock title="Business information" step={2} onEdit={onEdit}>
        <RegistrationReviewRow
          label="Business name"
          value={formData.business.shopName}
        />
        ...
        <RegistrationReviewRow
          label="Location"
          value={
            locationSummary || formData.business.businessLocation.address || "—"
          }
        />
