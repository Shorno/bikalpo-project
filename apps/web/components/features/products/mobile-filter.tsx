    ...
    <Sheet open={open} onOpenChange={setOpen}>
      <SheetTrigger asChild>
        <Button
          variant="outline"
          size="sm"
          className="relative gap-2 border-emerald-200 hover:bg-emerald-50 text-emerald-700"
        >
          <Filter size={16} />
