...
interface VerifiedCustomersHeroProps {
  totalCount: number;
  areas: string[];
  topCustomers: Array<{
    id: string;
...
export function VerifiedCustomersHero({
  totalCount,
  areas,
  topCustomers,
}: VerifiedCustomersHeroProps) {
      ...
      <div className="relative py-16 md:py-24">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-200 text-lg mb-8">
            See real wholesale buyers and their purchase history.
          </p>
