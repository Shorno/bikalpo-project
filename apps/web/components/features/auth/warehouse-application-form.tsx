...
import { CheckCircle, FileText, Loader, Loader2, MapPin, Pencil, Upload, Warehouse as WarehouseIcon, XIcon } from "lucide-react";
...
export function WarehouseApplicationForm({ initialData, isEditMode }: WarehouseApplicationFormProps) {
                    ...
                    return (
                        <div key={step.id} className="flex items-center">
                            <div className="flex flex-col items-center gap-1.5">
                                ...
                                <span
                                    className={`text-xs font-medium ${isActive ? "text-amber-600" : isCompleted ? "text-green-600" : "text-gray-400"
                                        }`}
                                >
                                    {step.title}
                                </span>
                                    ...
                                    <div className="space-y-3">
                                        <div className="rounded-lg bg-gray-50 p-4">
                                            <div className="mb-2 flex items-center justify-between">
                                                <h4 className="text-sm font-semibold text-gray-700">Warehouse Details</h4>
                                                <Button
                                                    type="button"
                                                    variant="ghost"
                                                    size="sm"
                                            ...
                                            <div className="space-y-1.5 text-sm">
                                                <div className="flex justify-between">
                                                    ...
                                                    <span className="font-medium">{values.warehouseName || "—"}</span>
                                                </div>
                                                <div className="flex justify-between">
                                        ...
                                        <div className="rounded-lg bg-gray-50 p-4">
                                            ...
                                            <div className="space-y-1.5 text-sm">
                                                ...
                                                <div className="flex justify-between">
                                                    ...
                                                    <span className="max-w-50 text-right font-medium">{values.warehouseAddress || "—"}</span>
                                                </div>
                                            </div>
                                        </div>
