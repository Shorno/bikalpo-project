            ...
            <div className="max-w-7xl mx-auto">
                <div className="max-w-3xl">
                    ...
                    <p className="text-xl text-gray-500 leading-relaxed mb-8">
                        Choose a plan that fits your business needs. Scale your
                        inventory, manage multiple warehouses, and streamline
                        operations with our architectural approach to commerce.
                    </p>
