            ...
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-16 items-center">
                ...
                <div className="flex-1 order-1 md:order-2">
                    ...
                    <p className="text-gray-500 mb-8 text-lg">
                        Specifically designed for large-scale operations
                        requiring real-time syncing across global nodes. Our
                        enterprise solution offers dedicated support and custom
                        API integrations.
                    </p>
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-500">
                                    Priority response for mission-critical
                                    issues.
                                </p>
                            </div>
                        </div>
