const features = [
  ...
  },
  {
    icon: "groups",
    title: "SR System",
    description: "Manage your sales representatives effectively in the field.",
  },
  {
    icon: "point_of_sale",
    title: "Smart POS",
  ...
  },
  {
    icon: "badge",
    title: "HRM & Payroll",
    description: "Streamline employee management and salary disbursements.",
  },
  {
    icon: "sms",
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="mb-16">
          ...
          <p className="text-gray-600 max-w-2xl">
            Everything you need to manage and grow your business in one cohesive
            ecosystem.
          </p>
        </div>
