...
const advantages = [
  ...
  },
  {
    ...
    description: "Build brand advocates with sophisticated tier-based rewards.",
  },
  {
    icon: "share_reviews",
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
        ...
        <div className="lg:sticky lg:top-32 self-start">
          ...
          <p className="text-lg text-gray-500 mb-8 leading-relaxed">
            We didn&apos;t just build a list of tools; we engineered an
            ecosystem. Every module in Bikalpo communicates seamlessly, ensuring
            that a sale in Barishal instantly updates your financial ledger in
            Khulna.
          </p>
          ...
          >
            <p className="italic text-lg mb-6 leading-relaxed">
              &ldquo;Bikalpo transformed our chaos into a well-oiled machine.
              The inventory sync alone saved us 20 hours a week.&rdquo;
            </p>
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm opacity-80">CEO, Delta Retail Group</p>
              </div>
            </div>
          </div>
        </div>
