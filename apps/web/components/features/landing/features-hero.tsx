      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col items-start max-w-3xl">
          ...
          <p className="text-xl text-gray-500 leading-relaxed opacity-80">
            Stop juggling multiple platforms. Bikalpo unifies your entire
            operation—from local inventory to global marketing—into one
            architectural masterpiece of efficiency.
          </p>
        </div>
      </div>
    </section>
