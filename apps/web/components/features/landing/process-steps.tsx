export function ProcessSteps() {
  const steps = [
    ...
    },
    {
      number: 2,
      title: "Select Plan",
      description: "Choose the perfect scale for your current needs.",
    },
    {
      number: 3,
      title: "Setup Store",
      description: "Configure your business details and go live.",
    },
  ];
        ...
        <div className="grid md:grid-cols-3 gap-12 relative">
          ...
          {steps.map((step) => (
            <div key={step.number} className="flex flex-col items-center">
              ...
              <p className="text-gray-600 text-sm px-8">{step.description}</p>
            </div>
          ))}
        </div>
      </div>
