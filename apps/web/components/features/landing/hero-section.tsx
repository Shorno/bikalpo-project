      ...
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
        <div className="relative z-10">
          ...
          >
            ...
            with <span className="text-[#003178]">Bikalpo</span>
          </h1>

          {/* Description */}
          <p className="text-xl text-gray-600 mb-8 max-w-xl leading-relaxed">
            Your Ultimate Business Management Platform. Streamline operations,
            boost sales, and scale your brand with architectural precision.
          </p>
