...
export function DaybookCustomerAdvanceDialog({
  ...
  const [advanceType, setAdvanceType] = useState<AdvanceType>(
    ADVANCE_TYPES[0] ?? "Sales Order Advance",
  );
  ...
  const resetForm = () => {
    ...
    setAdvanceType(ADVANCE_TYPES[0] ?? "Sales Order Advance");
    setDescription("");
    setAmount("");
    setNotes("");
  };
      ...
      <DialogContent className="max-h-[92vh] overflow-y-auto bg-slate-50 p-0 sm:max-w-5xl">
        ...
        <div className="px-5 py-6">
          <div className="grid gap-5 lg:grid-cols-[minmax(0,1fr)_280px]">
            <div className="grid gap-5 md:grid-cols-3">
              <div className="grid gap-2">
                <Label htmlFor="customer-advance-customer">Customer</Label>
                <Input
                  className="h-10"
              ...
              <div className="grid gap-2">
                <Label htmlFor="customer-advance-customer-id">
                  Customer ID
                </Label>
                <Input
                  className="h-10"
          ...
          <div className="mt-6 grid gap-5 md:grid-cols-2 xl:grid-cols-4">
            ...
            <div className="grid gap-2">
              <Label htmlFor="customer-advance-reference">Ref no.</Label>
              <Input
                className="h-10"
            ...
            <div className="grid gap-2">
              <Label htmlFor="customer-advance-type">Advance Type</Label>
              <Select
          ...
          <div className="mt-6 overflow-hidden rounded-lg border border-slate-200 bg-white">
            <div className="grid grid-cols-[56px_repeat(3,minmax(0,1fr))] border-slate-200 border-b bg-slate-50 px-4 py-3 font-semibold text-slate-700 text-sm">
              <span>#</span>
              <span>ADVANCE TYPE</span>
              <span>DESCRIPTION</span>
              <span className="text-right">AMOUNT</span>
            </div>
            <div className="grid grid-cols-[56px_repeat(3,minmax(0,1fr))] items-center gap-2 px-4 py-4">
              <span className="font-medium text-slate-500">1</span>
              <span className="font-medium text-slate-900">{advanceType}</span>
              <Input
                aria-label="Advance description"
                className="h-10 w-full"
                onChange={(event) => setDescription(event.target.value)}
                placeholder="Sales order optional / not delivered yet"
                value={description}
              />
              <Input
