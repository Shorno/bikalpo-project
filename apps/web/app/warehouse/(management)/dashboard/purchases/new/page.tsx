...
export default function NewPurchasePage() {
    ...
    const [items, setItems] = useState<PurchaseItemRow[]>([
        { variantId: 0, productName: "", quantity: "", unitCost: "", batchNo: "", expiryDate: "" },
    ]);
        ...
        <div className="p-6 max-w-4xl mx-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="bg-white border border-gray-200 rounded-xl p-5">
                    <h2 className="text-sm font-semibold text-gray-700 mb-4">Purchase Details</h2>
                ...
                <div className="bg-white border border-gray-200 rounded-xl p-5">
                            ...
                            >
                                <div className="grid grid-cols-12 gap-2 items-start">
                                    ...
                                    <div className="col-span-5 relative">
                                        <label className="block text-[10px] uppercase text-gray-400 font-semibold mb-1">Product</label>
                                        {item.variantId > 0 ? (
                                            <div
                                            ...
                                            <>
                                                <input
                                                    ...
                                                    onFocus={() => { setActiveDropdown(index); setVariantSearch(""); }}
                                                            ...
                                                            variants.map((v: any) => (
                                                                ...
                                                                >
                                                                    ...
                                                                    <span className="text-xs text-gray-500 ml-1">
                                                                        — {v.unitLabel} ({v.weightKg}kg) • ৳{parseFloat(v.price).toLocaleString()}
                                                                    </span>
                                                                </button>
                                                            ))
                                                        )}
                                    ...
                                    <div className="col-span-2">
                                        <label className="block text-[10px] uppercase text-gray-400 font-semibold mb-1">Qty</label>
                                        <input
                                    ...
                                    {/* Unit Cost */}
                                    <div className="col-span-2">
                                        <label className="block text-[10px] uppercase text-gray-400 font-semibold mb-1">Unit Cost</label>
                                        <input
                                            type="number" step="0.01" min="0" placeholder="0"
                                            value={item.unitCost}
                                    ...
                                    <div className="col-span-2 text-right pt-6 text-sm font-medium text-gray-700">
                                        ৳{((parseFloat(item.quantity) || 0) * (parseFloat(item.unitCost) || 0)).toLocaleString()}
                                    </div>
                                ...
                                <div className="grid grid-cols-12 gap-2 mt-2">
                                    <div className="col-span-5">
                                        <label className="block text-[10px] uppercase text-gray-400 font-semibold mb-1">Batch No</label>
                                        <input
                                    ...
                                    <div className="col-span-4">
                                        <label className="block text-[10px] uppercase text-gray-400 font-semibold mb-1">Expiry Date</label>
                                        <input
                                            type="date"
                    ...
                    <div className="mt-4 pt-3 border-t border-gray-100">
                        ...
                        <div className="flex justify-between items-center mb-2">
                            ...
                            <span className="text-sm text-gray-700">৳{transport.toLocaleString()}</span>
                        </div>
                        <div className="flex justify-between items-center pt-2 border-t border-gray-200">
                            <span className="text-xs text-gray-500 uppercase font-semibold">Grand Total</span>
