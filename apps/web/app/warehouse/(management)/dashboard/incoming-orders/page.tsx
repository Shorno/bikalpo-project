  ...
  const updateStatusMutation = useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({
        queryKey: ["warehouse", "getIncomingOrders"],
      });
    },
  });
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Orders from shop owners and other warehouses
          </p>
        </div>
        <select
          value={statusFilter}
              ...
              >
                ...
                {isExpanded && (
                  <div className="border-t px-4 pb-4 pt-3 space-y-3 bg-gray-50/50">
                    ...
                    {o.customerNote && (
                      <p className="text-xs text-gray-500 italic bg-yellow-50 border border-yellow-200 rounded p-2">
                        Note: {o.customerNote}
                      </p>
                    )}
