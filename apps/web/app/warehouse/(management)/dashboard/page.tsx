...
export default function WarehouseDashboardPage() {
  ...
  const showSessionSkeleton = !hasMounted || sessionLoading;
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        />
        <StatCard
          icon={<Loader2 className="w-5 h-5 text-purple-600" />}
          label="Processing"
          value={statsLoading ? null : "0"}
          bg="bg-purple-50"
        />
        <StatCard
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div className="bg-white rounded-lg border shadow-sm">
          <div className="px-5 py-4 border-b flex items-center justify-between">
            ...
            <Link
              href="/warehouse/dashboard/sales-team"
              ...
              <tbody className="divide-y divide-gray-100">
                {[
                  ...
                  <tr key={s.name} className="hover:bg-gray-50/50">
                    ...
                    <td className="px-4 py-2.5 text-right text-gray-600">
                      {s.target ? Math.round((s.sales / s.target) * 100) : 0}%
                    </td>
                  </tr>
                ))}
              </tbody>
              ...
              <tbody className="divide-y divide-gray-100">
                {[
                  ...
                  <tr key={d.name} className="hover:bg-gray-50/50">
                    ...
                    <td className="px-4 py-2.5 text-right text-gray-600">
                      {d.deliveries
                        ? Math.round((d.completed / d.deliveries) * 100)
                        : 0}
                      %
                    </td>
                  </tr>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <StatCard
          ...
          value="0"
          bg="bg-blue-50"
          href="/warehouse/dashboard/connected-stores"
        />
        <StatCard
        ...
        />
        <StatCard
          icon={<BoxIcon className="w-5 h-5 text-amber-600" />}
          label="Total SKU"
          value="0"
          bg="bg-amber-50"
        />
      ...
      <div className="bg-white rounded-lg border shadow-sm">
        ...
        <div className="divide-y divide-gray-100">
          {[
            {
              text: "New Store Request",
              time: "Just now",
              type: "info" as const,
            },
            {
              text: "Supply Order Pending",
              time: "5 min ago",
            ...
            >
              <div
                className={`w-2 h-2 rounded-full shrink-0 ${n.type === "alert" ? "bg-red-400" : n.type === "warning" ? "bg-amber-400" : "bg-blue-400"}`}
              />
