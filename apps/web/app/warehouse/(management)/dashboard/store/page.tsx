    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg border shadow-sm p-6">
        ...
        <p className="text-sm text-muted-foreground mb-4">
          Your warehouse storefront is accessible via direct URL only. It is not
          listed publicly on the platform. Share this link or QR code with shop
          owners and other warehouses.
        </p>
