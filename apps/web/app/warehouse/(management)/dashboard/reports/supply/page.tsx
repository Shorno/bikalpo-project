...
export default function SupplyReportPage() {
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-bold text-gray-900">Supply Report</h1>
      <div className="bg-white rounded-lg border shadow-sm p-12 flex flex-col items-center justify-center text-center">
        ...
        <h2 className="text-lg font-semibold text-gray-700 mb-2">Supply Report</h2>
        <p className="text-sm text-gray-500 max-w-md">
          Supply chain performance and order fulfillment reports.
        </p>
