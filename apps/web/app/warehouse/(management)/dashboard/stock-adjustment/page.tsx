    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg border shadow-sm p-12 flex flex-col items-center justify-center text-center">
        <div className="w-16 h-16 bg-gray-100 rounded-2xl flex items-center justify-center mb-4">
          <ArrowRightLeftIcon className="w-8 h-8 text-gray-400" />
        </div>
        <h2 className="text-lg font-semibold text-gray-700 mb-2">Stock Adjustment</h2>
        <p className="text-sm text-gray-500 max-w-md">
          Record stock adjustments, write-offs, and corrections.
        </p>
