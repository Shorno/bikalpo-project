...
import { Warehouse, MapPin, Package, AlertCircle, Loader2, Search } from "lucide-react";
...
export default function WarehouseStorefrontPage() {
    ...
    const { data: warehouse, isLoading: warehouseLoading, error: warehouseError } =
        useQuery(
                ...
                <div className="container mx-auto px-4 py-8">
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <Badge variant="secondary" className="mt-2 bg-amber-100 text-amber-700 border-amber-200">
                                Verified Warehouse
                            </Badge>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-wrap gap-2 mt-3">
                        ...
                        {categories.map((cat) => (
                            <Button
                                ...
                                className={selectedCategory === cat.slug ? "bg-amber-600 hover:bg-amber-700" : ""}
                            >
