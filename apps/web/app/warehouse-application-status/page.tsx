...
const statusConfig = {
  pending: {
    ...
    description:
      "Our team is reviewing your warehouse application. This usually takes 1-2 business days.",
  ...
  approved: {
    ...
    description:
      "Congratulations! Your warehouse account has been approved. You can now access your warehouse dashboard.",
  ...
  rejected: {
    ...
    description:
      "Unfortunately, your warehouse application was not approved at this time. Please review the notes below and consider reapplying.",
    color: "text-red-600",
    bgColor: "bg-red-100",
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex flex-col gap-3 pt-2">
            {application.status === "pending" && (
              ...
              >
                <Link href="/apply-warehouse?edit=true">Edit Application</Link>
              </Button>
            )}
