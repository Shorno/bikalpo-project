        ...
        return (
            <div className="flex flex-col items-center justify-center py-16 text-center">
                ...
                <Button asChild className="mt-4" size="sm">
                    <Link href="/account/complaints">Back to Complaints</Link>
                </Button>
            </div>
        );
    }
                ...
                <div className="flex-1">
                    ...
                    <p className="text-xs text-muted-foreground mt-0.5">
                        ...
                        {complaint.orderNumber && (
                            <> · Order <Link href={`/account/orders/${complaint.orderNumber}`} className="text-emerald-600 hover:underline">{complaint.orderNumber}</Link></>
                        )}
                    </p>
                </div>
            </div>
                        ...
                        <CardContent className="pt-0 space-y-3">
                            <div className="space-y-2 text-sm">
                                <div className="flex justify-between">
                                    ...
                                    <Link href={`/account/orders/${complaint.orderNumber}`} className="font-medium text-emerald-600 hover:underline">
