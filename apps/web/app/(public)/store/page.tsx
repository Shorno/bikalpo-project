...
import { AlertCircle, MapPin, Search, ShoppingBag, Store } from "lucide-react";
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      {isLoading ? (
        ...
        <div className="text-center py-16">
          ...
          <p className="text-gray-500 font-medium">Failed to load shops</p>
        </div>
      ) : shops.length === 0 ? (
        <div className="text-center py-16">
                  ...
                  <div className="p-4">
                    {shop.shopAddress && (
                      <div className="flex items-start gap-2 text-sm text-gray-500">
                        ...
                        <span className="line-clamp-2">{shop.shopAddress}</span>
                      </div>
                    )}
                  </div>
                </div>
