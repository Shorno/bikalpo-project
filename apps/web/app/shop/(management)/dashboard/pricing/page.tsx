    ...
    <div className="space-y-4">
      ...
      {isLoading ? (
        ...
        <div className="bg-white rounded-lg border shadow-sm p-12 text-center">
          ...
          <p className="text-gray-500 font-medium">No products to price yet</p>
          <p className="text-sm text-gray-400 mt-1">
            Once you have retail inventory, you can set your selling prices
            here.
          </p>
        </div>
      ) : (
          ...
          <Table>
            ...
            <TableBody>
              {items.map((item: any) => {
                ...
                const costPrice = Number(variant?.price || prod?.price || 0);
                const retailPrice = item.retailPrice
                  ? Number(item.retailPrice)
                  : null;
                const margin =
                  retailPrice && costPrice > 0
                    ? (((retailPrice - costPrice) / costPrice) * 100).toFixed(1)
                    : null;
                ...
                return (
                  <TableRow key={item.id}>
                    ...
                    <TableCell className="text-sm text-gray-500">
                      {variant?.quantitySelectorLabel || variant?.sku || "—"}
                    </TableCell>
                        ...
                        <div className="flex items-center justify-end gap-1">
                          ...
                          <Button
                            ...
                            onClick={() =>
                              startEdit(
                                item.id,
                                retailPrice?.toString() || costPrice.toString(),
                              )
                            }
                          >
