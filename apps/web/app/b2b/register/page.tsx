...
const STEP_TITLES: Record<number, { title: string; description: string }> = {
  1: {
    ...
    description: "Verify your phone and create your account",
  },
...
export default function RegisterPage() {
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: changing steps must move focus to the new step heading
  useEffect(() => {
