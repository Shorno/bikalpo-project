        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 sm:p-6 mb-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div className="flex items-center gap-4">
              ...
              >
                {application.warehouseName?.[0]?.toUpperCase() || "W"}
              </div>
              <div>
                <h1
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2 space-y-5">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              <div className="bg-white rounded-xl border border-gray-100 p-4 text-center">
                ...
                <p className="text-sm font-bold text-gray-900">Warehouse</p>
              </div>
              <div className="bg-white rounded-xl border border-gray-100 p-4 text-center">
                <span
                  className="material-symbols-outlined text-2xl text-[#003178] mb-1 block"
            ...
            <DetailSection title="Warehouse Details" icon="warehouse">
              <DetailField label="Warehouse Name" value={application.warehouseName} />
              <DetailField
                label="Trade License"
            ...
            <DetailSection title="Location" icon="location_on">
              ...
              <DetailField label="Address" value={application.warehouseAddress} />
          ...
          <div className="space-y-5 lg:sticky lg:top-6 self-start">
            ...
            <div className="bg-white rounded-xl border border-gray-100 overflow-hidden">
              <div className="bg-gradient-to-br from-[#e65100] to-[#f57c00] px-5 py-6 text-center">
                ...
                <p className="text-white/70 text-xs mt-0.5">Warehouse Applicant</p>
              </div>
