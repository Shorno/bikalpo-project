  ...
  return (
    <section className="px-4 py-6 sm:px-6 sm:py-8">
      ...
      <div className="mx-auto max-w-6xl" style={{ fontFamily: "'Inter', sans-serif" }}>
        ...
        <ApplicationDetailHeader
          title={application.warehouseName}
          ownerName={application.ownerName}
          createdAt={application.createdAt}
          applicationNumber={detail.applicationNumber}
          status={status}
          avatarInitial={application.warehouseName?.[0]?.toUpperCase() || "W"}
          avatarClassName="bg-gradient-to-br from-[#e65100] to-[#f57c00]"
          isPending={isPending}
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          ...
          <div className="space-y-5 self-start lg:sticky lg:top-6">
            <ApplicantSummaryCard
              data={detail}
              subtitle="Warehouse Applicant"
              gradientClass="bg-gradient-to-br from-[#e65100] to-[#f57c00]"
            />
