...
### Shorno upstream integration (2026-08-13)

- Merged the latest `Shorno/bikalpo-project` `main` snapshot at commit
  `412528302c9f52dc6580ff14529f7696bf0d43ad` into Rayhan's To-Let work.
- Preserved Shorno's existing migrations `0039`–`0046`; the To-Let migrations are
  numbered `0047`–`0050` so migration ordering remains unique.
