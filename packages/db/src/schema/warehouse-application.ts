...
import type { ApplicationDocumentUrls } from "./seller-application";
...
export const warehouseApplication = pgTable(
    ...
    (table) => [
        ...
        uniqueIndex("warehouse_application_number_idx").on(table.applicationNumber),
    ],
);
...
export const warehouseApplicationRelations = relations(warehouseApplication, ({ one }) => ({
    ...
    productType: one(productType, {
        fields: [warehouseApplication.productTypeId],
